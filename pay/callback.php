...
error_log("Raw callback input: " . file_get_contents('php://input'));

$response = [];
if ($callbackData) {
    // Try different possible field names for CheckoutRequestID
    if (isset($callbackData['CheckoutRequestID'])) {
        $response = $callbackData;
    } elseif (isset($callbackData['checkout_request_id'])) {
        $response = $callbackData;
        // Normalize field names
        $callbackData['CheckoutRequestID'] = $callbackData['checkout_request_id'];
        $callbackData['Status'] = $callbackData['status'] ?? $callbackData['Status'];
        $callbackData['ResultCode'] = $callbackData['result_code'] ?? $callbackData['ResultCode'];
        $callbackData['MpesaReceiptNumber'] = $callbackData['mpesa_receipt_number'] ?? $callbackData['MpesaReceiptNumber'];
        $callbackData['ResultDesc'] = $callbackData['result_desc'] ?? $callbackData['ResultDesc'];
        $response = $callbackData;
